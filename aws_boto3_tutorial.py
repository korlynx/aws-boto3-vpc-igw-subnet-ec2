...
# Create a custom subnet for your ec2 instance
...
route_table_association = route_table.associate_with_subnet(SubnetId = subnet1_id)
...
# Launch an EC2 instance in one the subnet and AZ. Also creates a txt file inside the temp directory using the "user data" option
instances = ec2.create_instances(
    ...
    MinCount=1,
    UserData='''#!/bin/bash
    echo 'Hello World!' > /tmp/test.txt''', # add ou custom script here
    NetworkInterfaces=[
        {
